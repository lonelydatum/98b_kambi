...
function init_728x90() {
  ...
  tl.set(".frame1", { opacity: 1 });
  tl.from(".t1", { opacity: 0, duration: 0.3 }, "+=.3");
  tl.from(".arrows", { opacity: 0, duration: 0.3, y: "+=20" }, "+=" + _commonJsCommonJs.read.t1);

  tl.from(".phone_1", { opacity: 0, y: "+=40", duration: 0.4 });
  tl.from(".t2", { opacity: 0, duration: 0.3 }, "+=.3");

  tl.to(".t2", { opacity: 0, duration: 0.3 }, "+=" + _commonJsCommonJs.read.t2);
  tl.from(".t3", { opacity: 0, duration: 0.3 }, "+=.3");

  tl.to(".t3", { opacity: 0, duration: 0.3 }, "+=" + _commonJsCommonJs.read.t3);
